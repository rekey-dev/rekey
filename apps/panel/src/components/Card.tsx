 ...
 *
 * - `padded` (default true) applies the standard internal padding. Set false
 *   when the card wraps a <Table>, which manages its own cell padding.
 * - `as` lets a card be a <section>/<li>/etc. while keeping the visual shell.
 *
 * Section grouping (a heading above a card) is expressed with <SectionHeader>.
 */
