...
//
// Pass the id as a build arg when you build the panel image; if you
...
//
// This file lives under app/ (not components/) because next/script's
// beforeInteractive strategy below is only allowed in the root layout's
// subtree; Next's own lint rule enforces that by path.
