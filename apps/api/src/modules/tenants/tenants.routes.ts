...
const TenantLimitsView: JsonSchema = {
  type: "object",
  description:
    "A workspace's resource ceilings plus what is currently counted against them.",
  properties: {
  ...
  app.get(
    "/",
    {
      schema: {
        ...
        description:
          "Returns Tenants newest-first (paginated). Bootstrap-admin only.",
        querystring: {
          type: "object",
    ...
    "/:id/limits",
    {
      schema: {
        ...
        response: {
          200: ok(
            TenantLimitsView,
            "The workspace's ceilings plus current usage.",
          ),
          ...errs({
            ...SUPER_ADMIN_ERRORS,
            404: "TENANT_NOT_FOUND — no tenant with that id.",
    ...
    "/:id/limits",
    {
      schema: {
        ...
        response: {
          200: ok(
            TenantLimitsView,
            "The workspace's ceilings plus current usage, after the update.",
          ),
          ...errs({
            400:
