/** Shared product constants — the Rekey meter / plan / feature slugs. */
...
/** Free-tier defaults (also encoded as Rekey entitlements on the Free plan).
 *
 ...
 * of `usage.record` calls — Rekey's global 100 req/min rate limiter (no env
